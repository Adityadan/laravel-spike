    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar container-fluid">
            <ul id="sidebarnav">
                ...
                <!-- ============================= -->
                <li class="sidebar-item">
                    <a class="sidebar-link two-column has-arrow indigo-hover-bg" href="#"
                        aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="../dark/app-email.html"
                                aria-expanded="false">
                                <span class="sidebar-icon"></span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link two-column has-arrow primary-hover-bg" href="#"
                        aria-expanded="false">
                ...
                <!-- =================== -->
                <li class="sidebar-item">
                    <a class="sidebar-link two-column has-arrow success-hover-bg" href="#"
                        aria-expanded="false">
