                                                ...
                                                <div class="position-relative">
                                                    <a href="../dark/app-chat.html"
                                                        ...
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold bg-hover-primary">
                                                                Chat Application</h6>
                                                            <span class="fs-2 d-block text-dark">New
                                                    ...
                                                    <a href="../dark/app-contact2.html"
                                                        ...
                                                        <div class="d-inline-block">
                                                            ...
                                                            <span class="fs-2 d-block text-dark">2
                                                ...
                                                <div class="position-relative">
                                                    <a href="../dark/page-user-profile.html"
                                                        ...
                                                        <div class="d-inline-block">
                                                            <h6 class="mb-1 fw-semibold bg-hover-primary">
                                                                User Profile</h6>
                                                            <span class="fs-2 d-block text-dark">learn
                                                    ...
                                                    <a href="../dark/app-contact.html"
                                                        ...
                                                        <div class="d-inline-block">
                                                            ...
                                                            <span class="fs-2 d-block text-dark">Add
                                                                new contact</span>
                                                        </div>
                                                    </a>
                                                    <a href="../dark/app-notes.html"
                                                        ...
                                                        <div class="d-inline-block">
                                                            ...
                                                            <span class="fs-2 d-block text-dark">To-do
                                    ...
                                    <div class="row align-items-center py-3">
                                        <div class="col-8">
                                            <a class="fw-semibold text-dark d-flex align-items-center lh-1 text-decoration-none"
                                                href="#"><iconify-icon icon="solar:question-circle-line-duotone"
                                                    class="fs-6 me-2"></iconify-icon>Frequently
                                                Asked Questions</a>
                                        </div>
                                        <div class="col-4">
                            ...
                            <div class="col-4 ms-n4">
                                <div class="position-relative p-6 border-start h-100">
                                    ...
                                    <ul class="">
                                        ...
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none"
                                                href="../dark/authentication-register.html">Register
                                                Now</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none"
                                                href="../dark/authentication-error.html">404 Error
                                                Page</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none"
                                        ...
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none"
                                                href="../dark/page-user-profile.html">User
                                                Application</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none"
                                                href="../dark/page-account-settings.html">Account
                                                Settings</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="message-body" data-simplebar>
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        <div class="w-100 d-inline-block v-middle ps-3">
                                            ...
                                            <span class="fs-2 text-nowrap d-block fw-normal mt-1 text-muted">Salma
                                                sent you new
                                                message</span>
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        <div class="w-100 d-inline-block v-middle ps-3">
                                            ...
                                            <span class="fs-2 text-nowrap d-block fw-normal mt-1 text-muted">Check
                                                your
                                                earnings</span>
                                        </div>
                                    </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="profile-dropdown position-relative" data-simplebar>
                                    ...
                                    <div class="message-body">
                                        ...
                                        <a href="../dark/app-notes.html"
                                            ...
                                            <div class="w-75 d-inline-block v-middle ps-3 ms-1">
                                                ...
                                                <span class="fs-3 text-nowrap d-block fw-normal mt-1 text-muted">To-do
                                                    and Daily
                                                    Tasks</span>
                                            </div>
                                        </a>
                                    ...
                                    <div class="py-6 px-7 mb-1">
                                        <a href="javascript:void(0)" id="logout" onclick="logout()" class="btn btn-primary w-100">Log
                                            Out</a>
                                    </div>
                                </div>
                            </div>
