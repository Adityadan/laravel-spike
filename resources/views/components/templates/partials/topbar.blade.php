    ...
    <div class="scroll-sidebar" data-simplebar>
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="mb-0">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link success-hover-bg" href="../dark/index2.html"
                        aria-expanded="false">
                ...
                <!-- =================== -->
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link warning-hover-bg" href="../dark/form-wizard.html"
                        aria-expanded="false">
                        <span class="aside-icon p-2 bg-warning-subtle rounded-1">
                ...
                <!-- =================== -->
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link secondary-hover-bg" href="../dark/icon-tabler.html"
                        aria-expanded="false">
                        <span class="aside-icon p-2 bg-secondary-subtle rounded-1">
                ...
                <!-- =================== -->
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link primary-hover-bg" href="../dark/icon-solar.html"
                        aria-expanded="false">
                        <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link success-hover-bg" href="../dark/authentication-error.html"
                        aria-expanded="false">
                        <span class="aside-icon p-2 bg-success-subtle rounded-1">
                            <iconify-icon icon="solar:danger-circle-line-duotone" class="fs-6"></iconify-icon>
                        </span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link primary-hover-bg"
                        href="../dark/authentication-maintenance.html" aria-expanded="false">
                        <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link success-hover-bg opacity-50" href="#"
                        aria-expanded="false">
                        <span class="aside-icon p-2 bg-success-subtle rounded-1">
        ...
        <div class="card bg-primary-subtle mb-0 shadow-none">
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between gap-3">
                    ...
                    <a href="../dark/authentication-login.html" class="position-relative" data-bs-toggle="tooltip"
